#!/usr/bin/env python3
"""
Tests for the standalone single-tile O_proj microkernel (oproj_tile.py).
...
exactly the sentinel.
    ...
    python -m pytest tests/kernels/test_oproj_tile.py
"""
...
from mega_attention.kernels.sm90.oproj_tile import OProjTile
from mega_attention.metadata.row_desc import build_row_desc, oproj_task_counts, decode_oproj_slot, cdiv
from mega_attention.reference.fused import o_scratch_reference
