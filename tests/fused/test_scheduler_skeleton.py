...
floating-point math. Asserts:
  ...
  * the kernel terminates (grid_sync init+exit) for several task-space shapes.
    ...
    python -m pytest tests/fused/test_scheduler_skeleton.py
    python -m pytest tests/fused/test_scheduler_skeleton.py -x
"""
...
from mega_attention.metadata.row_desc import ROW_M_TILE, build_row_desc, oproj_task_counts
from mega_attention.kernels.sm90.fused_fa_oproj_ar import FusedFaOprojArSkeleton, NUM_CTRL
