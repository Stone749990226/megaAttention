#!/usr/bin/env python3
"""
Packed-varlen FA payload test (fa_varlen_sm90.py FaWsAttnPacked).
...
full O_scratch to o_scratch_reference (torch causal SDPA).
    ...
    /usr/bin/python megaAttention/test_fa_packed.py
"""
...
from fa_varlen_sm90 import FaWsAttnPacked
from row_desc import build_row_desc
from reference_fused import fa_reference, o_scratch_reference
